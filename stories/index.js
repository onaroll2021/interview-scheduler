...
storiesOf("Appointment", module)
  ...
  .add("Show", () => <Show student="Lydia Miller-Jones" id={props.id} interview={props.interview} interviewer={interviewer} onEdit={action("onEdit")} onDelete={action("onDelete")} />)
  .add("Confirm", () => <Confirm message="Delete the appointment?" onConfirm={action("onConfirm")} onCancel={action("onCancel")} />)
  .add("Status", () => <Status message="Deleting" />)
  .add("Error", () => <Error message="Could not delete appointment." onClose={action("onClose")} />)
  .add("Form_Edit", () => <Form interviewers={interviewers} onSave={action("onSave")} onCancel={(action("onCancel"))} student="xyz" interviewer={3} />)
  .add("Form_Create", () => <Form interviewers={interviewers} onSave={action("onSave")} onCancel={(action("onCancel"))} />)
